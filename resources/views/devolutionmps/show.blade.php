            ...
            <div class="card">
              <div class="card-header">
                <table class="table">
                  <tbody>
                    <tr>
                      <td><h3 class="text-center">Devolucion de Material</h3></td>
                      <td width="20%">Nro.: {{ $devolutionmp->number }}</td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div class="card-body">
                      ...
                      <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>{{ date("d/m/Y", strtotime($devolutionmp->date_dev)) }}</td>
                          </tr>
                        </tbody>
                      </table>
                      <table class="table table-bordered table-striped">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <a class="btn btn-primary" href="{{ route('devolutionmps.exportpdf', $devolutionmp->id) }}" ><i class="fas fa-print"></i> Imprimir</a>
                  </div>
                </div>
