...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Adicionar Items de la Orden de Compra: <em>{{ $buyorder->number }}</em></h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                {!! Form::model($buyorder, ['route' => ['buyorder_material.store', $buyorder->id], 'method' => 'PUT']) !!}
                  <div class="row">
                ...
                <table id="row_standares" style="display: none;">
                  <tr>
                    ...
                    <td>
                      <input type="text" name="observation_mat[]" class="form-control" value="">
                    </td>
